...
<section class="woocommerce-customer-details">
	...
	<h2 class="border-title woocommerce-column__title"><?php _e( 'Billing address', 'woocommerce' ); ?></h2>
	...
	<?php if ( $show_shipping ) : ?>
		...
		<div class="woocommerce-column woocommerce-column--2 woocommerce-column--shipping-address col-2">
			<h2 class="border-title woocommerce-column__title"><?php _e( 'Shipping address', 'woocommerce' ); ?></h2>
			<address>
