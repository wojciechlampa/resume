...
<section class="my-account-register-form-section">
    <div class="row">
                ...
                <div class="u-column1 col-1">
                    ...
                    <section class="form-login-section">
                                <form class="woocommerce-form woocommerce-form-login login" method="post">
                                    <div class="row">
                                        <div class="small-12 large-4 large-offset-4 column column-form-login">
                                            <div class="inner">
                                                <h3 class="title"><?php esc_html_e( 'Login', 'woocommerce' ); ?></h3>
                                    ...
                                    <p class="form-row">
                                        ...
                                        <button type="submit" class="btn btn-big btn-brown" name="login" value="<?php esc_attr_e( 'Log in', 'woocommerce' ); ?>"><?php esc_html_e( 'Log in', 'woocommerce' ); ?></button>
                                    </p>
