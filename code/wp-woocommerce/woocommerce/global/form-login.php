            ...
            <div class="small-12 large-4 large-offset-4 column column-form-login">
                <div class="inner">
                    ...
                    <p class="form-row">
                        ...
                        <label class="label-redirect woocommerce-form__label woocommerce-form__label-for-checkbox inline">
                            <input class="woocommerce-form__input woocommerce-form__input-checkbox" name="rememberme"
                                   type="checkbox" id="rememberme" value="forever"/>
                            <span><?php esc_html_e('Remember me', 'woocommerce'); ?></span>
                        </label>
                        <button type="submit" class="btn btn-big btn-brown" name="login"
